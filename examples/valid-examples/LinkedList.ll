...
define i1 @Element.Equal(i8* %this, i8* %.other) {
	...
	%_17 = xor i1 1, %_12
	br i1 %_17, label %if_then18, label %if_else19
...
if_else19:
	...
	%_33 = call i1 %_32(i8* %this, i32 %_34, i32 %_37)
	%_38 = xor i1 1, %_33
	br i1 %_38, label %if_then39, label %if_else40
...
if_else40:
	...
	%_44 = load i1, i1* %_43
	br i1 %_44, label %if_then45, label %if_else46
...
if_then45:
	...
	%_55 = xor i1 1, %_54
	br i1 %_55, label %if_then56, label %if_else57
...
if_else46:
	...
	br i1 %_65, label %if_then66, label %if_else67
...
while_cond7:
	...
	%_11 = xor i1 1, %_10
	br i1 %_11, label %l1, label %l0

l1:
	%_13 = load i1, i1* %ret_val
	%_14 = xor i1 1, %_13
	br label %l2
...
l2:
	%_12 = phi i1 [ 0, %l0], [ %_14, %l1]

	br i1 %_14, label %while_body8, label %while_end9
...
while_body8:
	...
	%_22 = load i8*, i8** %var_elem
	%_21 = call i1 %_20(i8* %_15, i8* %_22)
	br i1 %_21, label %if_then23, label %if_else24
...
if_then23:
	...
	%_26 = load i32, i32* %aux04
	%_27 = icmp slt i32 %_26, 0
	br i1 %_27, label %if_then28, label %if_else29
...
if_else29:
	...
	%_45 = call i1 %_44(i8* %_39, i8* %_52)
	store i1 %_45, i1* %aux05

	%_53 = sub i32 0, 555
	call void (i32) @print_int(i32 %_53)
...
if_then56:
	...
	%_59 = load i8*, i8** %aux01
	store i8* %_59, i8** %prev

	%_60 = load i8*, i8** %aux01
	; List.GetNext : 8
	%_61 = bitcast i8* %_60 to i8***
	%_62 = load i8**, i8*** %_61
	%_63 = getelementptr i8*, i8** %_62, i32 8
	%_64 = load i8*, i8** %_63
	%_65 = bitcast i8* %_64 to i8* (i8*)*
	%_66 = call i8* %_65(i8* %_60)
	store i8* %_66, i8** %aux01

	%_67 = load i8*, i8** %aux01
	; List.GetEnd : 6
	...
	store i1 %_73, i1* %var_end

	%_74 = load i8*, i8** %aux01
	; List.GetElem : 7
	%_75 = bitcast i8* %_74 to i8***
	%_76 = load i8**, i8*** %_75
	%_77 = getelementptr i8*, i8** %_76, i32 7
	%_78 = load i8*, i8** %_77
	%_79 = bitcast i8* %_78 to i8* (i8*)*
	%_80 = call i8* %_79(i8* %_74)
	store i8* %_80, i8** %var_elem
...
while_cond6:
	...
	%_10 = xor i1 1, %_9
	br i1 %_10, label %while_body7, label %while_end8
...
while_body7:
	...
	br i1 %_17, label %if_then19, label %if_else20

...
@.Visitor_vtable = global [2 x i8*] [i8* bitcast (i32 (i8*, i8*)* @Visitor.visit to i8*), i8* bitcast (i32 (i8*)* @Visitor.hi to i8*)]
...
define i1 @Tree.Init(i8* %this, i32 %.v_key) {
	...
	store i32 %_0, i32* %key
	store i1 0, i1* %has_left
	store i1 0, i1* %has_right
	ret i1 1
}
...
%cond11:
	%_14 = load i1, i1* %cont
	br i1 %_14, label %while12, label %end13
...
%while12:
	...
	br i1 %_24, label %then25, label %else26
...
%then25:
	...
	br i1 %_34, label %then35, label %else36
...
%else26:
	...
	br i1 %_66, label %then67, label %else68
...
%cond0:
	%_3 = load i1, i1* %cont
	br i1 %_3, label %while1, label %end2
...
%while1:
	...
	br i1 %_13, label %then14, label %else15
...
%else15:
	...
	br i1 %_37, label %then38, label %else39
...
%then38:
	...
	br i1 %_47, label %then48, label %else49
...
%then60:
	...
	%_70 = xor i1 1, %_69	store i1 %_70, i1 %_71
...
%l1:
	...
	%_79 = xor i1 1, %_78	store i1 %_79, i1 %_71
%l0:
	br %_71, label %then80, label %else81
...
define i1 @Tree.Remove(i8* %this, i8* %.p_node, i8* %.c_node) {
	...
	br i1 %_6, label %then7, label %else8
...
%else26:
	...
	br i1 %_61, label %then64, label %else65
...
%then64:
	...
	%_74 = load i8*, i8** %my_null
	%_73 = call i1 %_72(i8* %_67, i8* %_74)
	...
	%_77 = load i8**, i8*** %_76
	%_78 = getelementptr i8*, i8** %_77, i32 9
	%_79 = load i8*, i8** %_78
	%_80 = bitcast i8* %_79 to i1 (i8*, i1)*
	%_81 = call i1 %_80(i8* %_75, i1 0)
...
%else65:
	...
	%_89 = load i8*, i8** %my_null
	%_88 = call i1 %_87(i8* %_82, i8* %_89)

	store i1 %_88, i1* %ntb
	%_90 = load i8*, i8** %p_node
	; Tree.SetHas_Right : 10
...
%cond0:
	...
	br i1 %_9, label %while1, label %end2
...
%end2:
	...
	%_45 = load i8*, i8** %my_null
	%_44 = call i1 %_43(i8* %_38, i8* %_45)
...
%else15:
	...
	br i1 %_36, label %then37, label %else38
...
%then37:
	...
	br i1 %_46, label %then47, label %else48
...
%end9:
	...
	%_25 = bitcast i8* %_24 to i8***
	%_26 = load i8**, i8*** %_25
	%_27 = getelementptr i8*, i8** %_26, i32 8
	%_28 = load i8*, i8** %_27
	%_29 = bitcast i8* %_28 to i1 (i8*)*
	%_30 = call i1 %_29(i8* %_24)

	br i1 %_30, label %then31, label %else32

...
@.B_vtable = global [1 x i8*] [i8* bitcast (i1 (i8*)* @B.set to i8*)]
@.C_vtable = global [1 x i8*] [i8* bitcast (i1 (i8*)* @C.reset to i8*)]
...
define i32 @main() {
	...
	%_5 = getelementptr [1 x i8*], [1 x i8*]* @.C_vtable, i32 0, i32 0
	store i8** %_5, i8*** %_4
...
define i32 @A.get(i8* %this) {
	...
	%_0 = load i1, i1* %data
	br i1 %_0, label %then1, label %else2

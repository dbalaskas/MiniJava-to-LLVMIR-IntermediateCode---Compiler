...
@.Derived_vtable = global [1 x i8*] [i8* bitcast (i32 (i8*, i32)* @Derived.set to i8*)]
...
define i32 @main() {
	...
	%_5 = getelementptr [1 x i8*], [1 x i8*]* @.Derived_vtable, i32 0, i32 0
	store i8** %_5, i8*** %_4
